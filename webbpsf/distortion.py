...
def distort_image(hdulist_or_filename, ext=0, to_frame="sci", fill_value=0, xnew_coords=None, ynew_coords=None, return_coords=False, aper=None):
    """Distort an image
    ...
    func = RegularGridInterpolator((yvals, xvals), hdu_list[ext].data, method="linear", bounds_error=False, fill_value=fill_value)
